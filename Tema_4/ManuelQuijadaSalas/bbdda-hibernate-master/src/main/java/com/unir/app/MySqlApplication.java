...
public class MySqlApplication {
    ...
    public static void main(String[] args) {
        ...
        try (Session session = HibernateMySqlConfig.getSessionFactory().openSession()) {
            ...
            log.info("Querys tema 4");
            for (Object o : employeesDao.selectEmployesByGenderDesc()){
                log.info("{}",o);
            }

            for (Object o : employeesDao.selecNumberEmployeesByMonth("December")){
                log.info("{}",o);
            }
            employeesDao.selectEmployesBestSalaryByDepartment("Marketing");
            employeesDao.selectEmployesSecondBestSalaryByDepartment("Marketing");
